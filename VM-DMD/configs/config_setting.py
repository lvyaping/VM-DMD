...
class setting_config:
    ...
    relational_kd = {
        ...
        'teacher': {
            ...
            'checkpoint': './Swin-Transformer-Semantic-Segmentation/pretrained/isic.pth',
            'model_kwargs': {
    ...
    init_stage0_swin_ckpt = './Swin-Transformer-Semantic-Segmentation/pretrained/isic.pthh'
